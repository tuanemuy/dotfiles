...
manual-test に渡す情報:
- テストソース: `docs/plans/{Issue番号}/testing.md`
- 成果物ディレクトリ: `docs/plans/{Issue番号}/manual-test/`
- Issue番号: #{Issue番号}
